...
public class FrmManHinhChinh extends JFrame implements ActionListener {
	...
	public void taoPanelMain() {
		...
		pnTest = new JPanel();
		pnTest.add(frmNhanVien.contentPane);
		...
		mainPanel.add(pnTest, "pnTest");
		mainPanel.add(pnDatPhong,"Panel Dat Phong");
	...
	public void taoSuKienChoButtonMenuTrai() {
		...
		btnNhanVien.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) {
				CardLayout c = (CardLayout) (pnTest.getParent().getLayout());
				c.show(pnTest.getParent(), "pnTest");
			}
		});
		...
		btnDatPhong.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) {
				...
				c.show(pnDatPhong.getParent(), "Panel Dat Phong");
			}
		});
	}
