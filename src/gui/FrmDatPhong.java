...
public class FrmDatPhong extends JFrame implements WindowListener {
	...
	private JTextField txtMaPH, txtHoTen, txtSdt, txtCCCD, txtEmail, txtPhai, txtDiaChi, txtNhapMa, txtSoNguoi,
			txtGhiChu;
	...
	public void createGUI() {
		...
		pnCustomer.setBorder(BorderFactory.createLoweredBevelBorder());
